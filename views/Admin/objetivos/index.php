...
<head>
    ...
    <!-- Popup -->
    <?php require 'includes/Popups/pop_objetivos.php'; ?>
...
<body>
    ...
    <section id="content">
        ...
        <!-- MAIN -->
        <main>
            <h1 class="title">Registro Objetivos</h1>
            <ul class="breadcrumbs">
                <li><a href="<?= RUTA ?>Admin">Inicio</a></li>
                <li class="divider">/</li>
                <li><a href="#" class="active">Objetivos</a></li>
            </ul>
                ...
                <div class="info-data">
                    <div class="contenedor_perfil">
                        <div class="contenedor_subtitulo_pagina">
                            <h3 id="subtitulo_objetivos">Lista de Objetivos</h3>
                        </div>
                        <div class="perfil">
                            <div class="contenedor_botones">
                                <div class="btn_principal">
                                    <button class="button2 efects__button btn_nuevo" id="btnAbrirModal_objetivos"><i class='bx bxs-add-to-queue icon'></i> Nuevo Registro</button>
                                </div>
                            ...
                            <div class="contenedor_buscador">
                                <input class="input" type="text" id="filtro_objetivos" placeholder="Buscar objetivos...">
                            </div>

                            <div class="contenedor_tabla">

                                <div class="Encabezado_tabla">
                                    <h1>Todos los Objetivos</h1>
                                ...
                                <table class="table table-bordered table-striped table-responsive-stack" id="tabla_objetivos">
...
<!-- Funcionalidad -->
<script src="<?= RUTA ?>assets/js/utils/objetivos/script.js"></script>
<script src="<?= RUTA ?>assets/js/utils/objetivos/controller.js"></script>
<script src="<?= RUTA ?>assets/js/utils/objetivos/validations.js"></script>