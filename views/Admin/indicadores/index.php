...
<head>
    ...
    <!-- Popup -->
    <?php require 'includes/Popups/pop_indicadores.php'; ?>
                ...
                <div class="info-data">
                    <div class="contenedor_perfil">
                        <div class="contenedor_subtitulo_pagina">
                            <h3 id="subtitulo_indicadores">Lista de Indicadores</h3>
                        </div>
                        <div class="perfil">
                            <div class="contenedor_botones">
                                <div class="btn_principal">
                                    <button class="button2 efects__button btn_nuevo" id="btnAbrirModal_indicadores"><i class='bx bxs-add-to-queue icon'></i> Nuevo Registro</button>
                                </div>
                            ...
                            <div class="contenedor_buscador">
                                <input class="input" type="text" id="filtro_indicadores" placeholder="Buscar indicadores...">
                            </div>
                            ...
                            <div class="contenedor_tabla">
                                ...
                                <table class="table table-bordered table-striped table-responsive-stack" id="tabla_indicadores">
                                    <thead class="thead-dark">
                                        <tr>
                                            <th class="th_tabla">#</th>
                                            <th class="th_tabla">Codigo</th>
                                            <th class="th_tabla">Nombre</th>
                                            <th class="th_tabla">Fórmula</th>
                                            <th class="th_tabla">Año</th>
                                            <th class="th_tabla">Descripción</th>
                                            <th class="th_tabla">Objetivo</th>
...
<!-- Funcionalidad -->
<script src="<?= RUTA ?>assets/js/utils/indicadores/script.js"></script>
<script src="<?= RUTA ?>assets/js/utils/indicadores/controller.js"></script>
<script src="<?= RUTA ?>assets/js/utils/indicadores/validations.js"></script>