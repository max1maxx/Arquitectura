...
<head>
    ...
    <!-- Popup -->
    <?php require 'includes/Popups/pop_metas.php'; ?>
...
<body>
    ...
    <section id="content">
        ...
        <!-- MAIN -->
        <main>
            <h1 class="title">Registro Metas</h1>
            <ul class="breadcrumbs">
                <li><a href="<?= RUTA ?>Admin">Inicio</a></li>
                <li class="divider">/</li>
                <li><a href="#" class="active">Metas</a></li>
            </ul>
                ...
                <div class="info-data">
                    <div class="contenedor_perfil">
                        <div class="contenedor_subtitulo_pagina">
                            <h3 id="subtitulo_metas">Lista de Metas</h3>
                        </div>
                        <div class="perfil">
                            <div class="contenedor_botones">
                                <div class="btn_principal">
                                    <button class="button2 efects__button btn_nuevo" id="btnAbrirModal_metas"><i class='bx bxs-add-to-queue icon'></i> Nuevo Registro</button>
                                </div>
                            ...
                            <div class="contenedor_buscador">
                                <input class="input" type="text" id="filtro_metas" placeholder="Buscar metas...">
                            </div>

                            <div class="contenedor_tabla">

                                <div class="Encabezado_tabla">
                                    <h1>Todos los Metas</h1>
                                ...
                                <table class="table table-bordered table-striped table-responsive-stack" id="tabla_metas">
                                    <thead class="thead-dark">
                                        <tr>
                                            <th class="th_tabla">#</th>
                                            <th class="th_tabla">Codigo</th>
                                            <th class="th_tabla">Indicador</th>
                                            <th class="th_tabla">Estado</th>
                                            <th class="th_tabla">Línea base</th>
                                            <th class="th_tabla">Comportamiento</th>
                                            <th class="th_tabla">Unidad de medida</th>
                                            <th class="th_tabla">Sentido Medición</th>
                                            <th class="th_tabla">Denominador</th>
                                            <th class="th_tabla">Primer Trimestre</th>
                                            <th class="th_tabla">Segundo Trimestre</th>
                                            <th class="th_tabla">Tercer Trimestre</th>
...
<!-- Funcionalidad -->
<script src="<?= RUTA ?>assets/js/utils/metas/script.js"></script>
<script src="<?= RUTA ?>assets/js/utils/metas/controller.js"></script>
<script src="<?= RUTA ?>assets/js/utils/metas/validations.js"></script>